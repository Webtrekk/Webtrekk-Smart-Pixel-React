...
import { webtrekkMiddleware, WebtrekkSmartPixelReact } from './../../lib/index';

const mockState = {dispatch: () => {}, getState: () => {}};
const mockNext = (action) => {return action;};

describe('webtrekkMiddleware', () => {
    let spyOnTrack;
    let spyOnTrackPage;
    let spyOnTrackAction;
    let webtrekkMiddlewareNext;
    ...
    describe('without custom actions', () => {
        beforeEach((done) => {
            WebtrekkSmartPixelReact.call((wtSmart) => {
                ...
                webtrekkMiddlewareNext = webtrekkMiddleware()(mockState)(mockNext);
        ...
        test('ignore undefined action', () => {
            ...
            expect(webtrekkMiddlewareNext(actionData)).toBe(actionData);
        });
        ...
        test('action with init data', (done) => {
            webtrekkMiddlewareNext({type: 'history/push', webtrekk: {
                type: 'webtrekk/init',
                data: {
    ...
    describe('with custom actions', () => {
        beforeEach(() => {
            webtrekkMiddlewareNext = webtrekkMiddleware({
        ...
        test('1', (done) => {
            webtrekkMiddlewareNext({type: 'history/push', payload: 'push new history'});
        ...
        test('2', (done) => {
            webtrekkMiddlewareNext({type: 'history/update', payload: 'update history'});
        ...
        test('3', (done) => {
            webtrekkMiddlewareNext({type: 'history/replace', payload: 'replace history'});
